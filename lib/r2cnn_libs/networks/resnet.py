...
lib_path = os.path.join(this_dir, '..')#,'..','..','R2CNN_lib')
...
from networks.attention import squeeze_excitation_layer, build_attention, build_inception, build_inception_attention
