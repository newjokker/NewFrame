...
lib_path = os.path.join(this_dir, '..','..')#,'saturn_lib-master')
sys.path.insert(0, lib_path)

from r2cnn_libs.losses import losses
from r2cnn_libs.networks import resnet
from r2cnn_libs.networks import mobilenet_v2
from r2cnn_libs.box_utils import encode_and_decode
from r2cnn_libs.box_utils import boxes_utils, iou, iou_rotate
from r2cnn_libs.box_utils import anchor_utils
from r2cnn_libs.configs import cfgs
from r2cnn_libs.losses import losses
from r2cnn_libs.box_utils import show_box_in_tensor
from r2cnn_libs.detection_oprations.proposal_opr import postprocess_rpn_proposals
from r2cnn_libs.detection_oprations.anchor_target_layer_without_boxweight import anchor_target_layer
from r2cnn_libs.detection_oprations.proposal_target_layer import proposal_target_layer
from r2cnn_libs.box_utils import nms_rotate
from r2cnn_libs.networks.layer import *
...
class DetectionNetwork(object):
    ...
    def postprocess_fastrcnn_r(self, rois, bbox_ppred, scores, img_shape,gpu_id=0):
        '''
    ...
    def build_whole_detection_network(self, input_img_batch, gtboxes_r_batch, gtboxes_h_batch, mask_batch,gpu_id=0):
