...
DATASET_NAME ='pascal'
CLASS_NUM =6
RPN_IOU_POSITIVE_THRESHOLD =0.8
FAST_RCNN_R_NMS_IOU_THRESHOLD =0.05
USE_DROPOUT =True
...
INFERENCE_IMAGE_PATH = '/home/qfm/txkj_qfm/R2CNN-Plus-Plus_Tensorflow_qfm_JYZ1/v0.0.8-C/tmpfiles/1tmp/crop_tmp'
