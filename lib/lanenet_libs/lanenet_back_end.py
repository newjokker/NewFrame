...
from ..lanenet_libs import lanenet_discriminative_loss
from ..lanenet_libs.semantic_segmentation_zoo import cnn_basenet
...
class LaneNetBackEnd(cnn_basenet.CNNBaseModel):
    ...
    def __init__(self, phase, cfg):
        ...
        self._embedding_dims = self._cfg.EMBEDDING_FEATS_DIMS
        self._binary_loss_type = self._cfg.LOSS_TYPE
