...
from lib.alphapose_libs.utils.transforms import get_func_heatmap_to_coord
from lib.alphapose_libs.utils.pPose_nms import pose_nms, write_json

DEFAULT_VIDEO_SAVE_OPT = {
    'savepath': 'result/1.mp4',
...
class DataWriter():
    ...
    def update(self):
        ...
        print(f'start the under-go threading')
        if self.save_video:
            ...
            if boxes is None or len(boxes) == 0:
                ...
                if self.opt.save_img or self.save_video or self.opt.vis:
                    if hm_data.size()[1] == 49:
                        from lib.alphapose_libs.utils.vis import vis_frame_dense as vis_frame
                    elif self.opt.vis_fast:
                        from lib.alphapose_libs.utils.vis import vis_frame_fast as vis_frame
                    else:
                        from lib.alphapose_libs.utils.vis import vis_frame
